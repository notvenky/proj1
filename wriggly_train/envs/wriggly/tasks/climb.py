...
class Physics(mujoco.Physics):
  ...
  def lift_leg(self):
    """Returns a vector from either leg to floor"""
    pass
  
  def lift_height(self):
    """Returns the higher of the distances between the legs and floor"""
    pass
  
  def climb(self):
    # should be a bool value which checks whether the robot has crossed the given barrier or not
    # 
    pass
...
class Wriggly(base.Task):
  ...
  def initialize_episode(self, physics):
    ...
    physics.named.data.qpos[7:] = self.random
