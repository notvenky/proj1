...
r[i] is the present amplitude of the ith joint, so as we update r[i] during each iteration, through the differential equation, we get the amplitude of the ith joint at the next time step
