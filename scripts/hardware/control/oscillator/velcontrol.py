...
# paste_string = 'Frequency: tensor([0.4269, 0.4580, 0.3367, 0.1783, 0.0728]), Amplitude: tensor([1.4807, 1.2686, 1.2144, 3.1425, 0.5063]), Phase: tensor([4.9962, 3.6685, 4.7326, 0.8897, 4.1073])'
