...
model = '/home/venky/proj1/wriggly_train/training/baselines/logs/ars/2023-09-16/2023-09-16_17-35-29/best_model.zip'
model = ARS.load(model)

# env = wriggly_from_swimmer.move()
env = dmc2gym.make(domain_name='wriggly', task_name='move', episode_length=5000, camera_id=5, height=480, width=600)
obs, info = env.reset()
...
imageio.mimwrite('wriggly_ars.mp4', frames, fps=60)
env.close()