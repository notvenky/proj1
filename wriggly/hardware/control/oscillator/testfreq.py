...
# paste_string = 'Reward: 1692.635872811644, Frequency: tensor([0.4143, 0.4051, 0.4245, 0.4876, 0.3694]), Amplitude: tensor([0.8463, 2.5716, 1.5641, 3.5766, 1.1244]), Phase: tensor([6.2332, 5.6452, 5.2335, 5.1607, 5.1339])'
...
paste_string = ' Reward: 2553.9197552065953, Frequency: tensor([0.6932, 0.5987, 0.3873, 0.2800, 0.6257]), Amplitude: tensor([0.8591, 2.8813, 0.8059, 2.6706, 0.6196]), Phase: tensor([4.8521, 1.9965, 4.9657, 1.0250, 2.7583])'
