...
info_string = 'Max Reward: 3298.573499617978, Frequency: tensor([0.1670, 0.4809, 0.2247, 0.3610, 0.3447]), Amplitude: tensor([0.5586, 1.7090, 1.3807, 1.9319, 0.8438]), Phase: tensor([1.9444, 6.2624, 4.2673, 0.1083, 4.8189])'
