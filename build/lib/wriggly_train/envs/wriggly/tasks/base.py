...
from wriggly_train.envs.wriggly import arenas
...
class BaseTask(composer.Task):
  def __init__(
    ...
    arena: T.Optional[composer.Entity] = None,
  ...
  @property
  def task_observables(self) -> 'collections.OrderedDict[str, composer.Observable]':
