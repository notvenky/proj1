...
# Control Table Addresses for XM430 W210
ADDR_TORQUE_ENABLE = 64                  # Address for enabling the torque
...
ADDR_PRESENT_CURRENT = 126               # Address for present current
