...
paste_string = 'Frequency: tensor([0.4916, 0.2262, 0.4490, 0.4511, 0.3306]), Amplitude: tensor([1.57, 3.14, 1.57, 3.14, 1.57]), Phase: tensor([0.7578, 2.0704, 0.4936, 5.0827, 1.1826])'
